...
export default function EmployeePolicy() {
  return (
    <div>
      <PageBreadcrumb pageTitle="Chính sách Lương, Bảo hiểm & Thuế" />
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="list-inside list-disc text-gray-500 dark:text-gray-400">
                ...
                <li>
                  <strong>Bảo hiểm y tế (BHYT):</strong> Công ty thực hiện đầy
                  đủ các nghĩa vụ về BHYT theo quy định của pháp luật, bao gồm
                ...
                <li>
                  ...
                  Công ty tuân thủ các quy định về bảo hiểm tai nạn lao động,
                  bệnh nghề nghiệp để đảm bảo quyền lợi cho người lao động trong
            ...
            <p className="text-xl/8 text-gray-500 dark:text-gray-400">
              ...
              trao đổi và quy định rõ ràng trong hợp đồng lao động và các quy
              chế nội bộ của công ty. Nếu có bất kỳ thắc mắc nào, nhân viên vui
              lòng liên hệ với bộ phận Nhân sự để được giải đáp.
            </p>
          </div>
        </div>
      </div>
