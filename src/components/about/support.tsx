    ...
    <div className="min-h-screen rounded-2xl border border-gray-200 bg-white px-5 py-7 dark:border-gray-800 dark:bg-white/[0.03] xl:px-10 xl:py-12">
      <div className="mx-auto w-full">
        ...
        <p className="mb-6 text-xl/8 text-gray-500 dark:text-gray-400">
          Tại Halo-Shop, sự hài lòng của khách hàng là ưu tiên hàng đầu. Đội ngũ
          hỗ trợ khách hàng chuyên nghiệp và nhiệt tình của chúng tôi luôn sẵn
          sàng giải đáp mọi thắc mắc và hỗ trợ bạn trong suốt quá trình mua sắm.
        </p>
        ...
        <div className="space-y-6">
          <div>
            ...
            <ul className="list-inside list-disc text-gray-500 dark:text-gray-400">
              ...
              <li>
                <strong>Email:</strong> Gửi yêu cầu hỗ trợ qua email đến địa chỉ{" "}
                <span className="text-theme-primary font-semibold">
              ...
              <li>
                <strong>Chat trực tuyến:</strong> Truy cập website của chúng tôi
                và sử dụng chức năng chat trực tuyến để được hỗ trợ ngay lập tức
                bởi các tư vấn viên.
              </li>
              <li>
              ...
              <li>
                ...
                hàng của Halo-Shop để được nhân viên tư vấn và hỗ trợ trực tiếp.
              ...
              <li>
                <strong>Trung tâm hỗ trợ trực tuyến:</strong> Tham khảo các câu
                hỏi thường gặp (FAQ) và hướng dẫn chi tiết trên trang{" "}
                <a href="#" className="text-theme-primary hover:underline">
                  Trung tâm hỗ trợ
                </a>{" "}
                của chúng tôi.
          ...
          <div>
            ...
            <ul className="list-inside list-disc text-gray-500 dark:text-gray-400">
              ...
              <li>
                Cung cấp thông tin về các chương trình khuyến mãi và ưu đãi hiện
                có.
              </li>
            </ul>
          </div>
