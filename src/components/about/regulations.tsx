      ...
      <div className="mx-auto w-full">
        ...
        <div className="space-y-6">
          <div>
            ...
            <ul className="list-inside list-disc text-gray-500 dark:text-gray-400">
              <li>
                ...
                nguồn gốc xuất xứ rõ ràng và đảm bảo chất lượng theo tiêu chuẩn
                nhà sản xuất.
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="list-inside list-disc text-gray-500 dark:text-gray-400">
              <li>
                Khách hàng có thể mua hàng trực tuyến trên website/ứng dụng hoặc
                trực tiếp tại các cửa hàng của Halo-Shop.
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="list-inside list-disc text-gray-500 dark:text-gray-400">
              <li>
                Chính sách đổi trả được áp dụng trong vòng 7 ngày kể từ ngày mua
                hàng theo các điều kiện quy định chi tiết{" "}
              ...
              <li>
                Sản phẩm đổi trả phải còn mới, chưa qua sử dụng, còn nguyên tem
                mác và hóa đơn mua hàng.
              </li>
              <li>
                Chính sách bảo hành được áp dụng cho một số sản phẩm nhất định
                theo thời gian và điều kiện bảo hành của nhà sản xuất. Thông tin
                chi tiết về bảo hành được cung cấp kèm theo sản phẩm.
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="list-inside list-disc text-gray-500 dark:text-gray-400">
              <li>
                Halo-Shop cam kết bảo mật tuyệt đối thông tin cá nhân của khách
                hàng theo chính sách bảo mật được công bố trên website/ứng dụng.
              </li>
              <li>
                Chúng tôi không chia sẻ thông tin khách hàng cho bất kỳ bên thứ
                ba nào khi chưa có sự đồng ý của khách hàng, trừ các trường hợp
          ...
          <div>
            ...
            <ul className="list-inside list-disc text-gray-500 dark:text-gray-400">
              <li>
                Khách hàng có trách nhiệm tuân thủ các quy định và hướng dẫn của
                nhân viên Halo-Shop tại cửa hàng.
              </li>
              <li>
                Mọi hành vi gây rối, làm ảnh hưởng đến hoạt động kinh doanh hoặc
                uy tín của Halo-Shop đều bị nghiêm cấm.
              </li>
              <li>
                Halo-Shop có quyền thay đổi các quy định này mà không cần thông
                báo trước. Các thay đổi sẽ được cập nhật trên website/ứng dụng
                của công ty.
              </li>
              <li>
